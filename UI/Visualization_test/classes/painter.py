...
class Painter:
    ...
    def plotBoxAndItems(self,title="",alpha=0.2,write_num=False,fontsize=10):
        ...
        self._plotCube(axGlob, float(0), float(0), float(0), float(50), float(50), float(50), color="blue", mode=2, text="", fontsize=fontsize, alpha=alpha)

        self._plotCube(axGlob, float(0), float(50), float(0), float(50), float(50), float(50), color="blue", mode=2, text="", fontsize=fontsize, alpha=alpha)
        ...
        #     plt.pause(0.1) # Pause for 5 seconds to display the figure
        #     counter = counter + 1
